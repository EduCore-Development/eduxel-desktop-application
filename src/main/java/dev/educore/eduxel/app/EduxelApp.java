...
public class EduxelApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        // Set window and taskbar icon (multiple sizes for best OS integration)
        try {
        ...
        // Notify controller that the primary stage is ready; perform DB bootstrap and initial load
